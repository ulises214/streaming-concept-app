...
const kColorCardsBackground = Color.fromRGBO(0XFF, 0XFF, 0XFF, 0.1);
...
const kColorUnselectedItem = Color(0xFF636D96);
const kFloatingActionButtonDyOffset = 16.0;
const kRadiusBigCard = Radius.circular(60.0);
const kRadiusSmallCard = Radius.circular(30.0);
final kGradientScaffoldBackground = LinearGradient(
  colors: [kColorDarkPurple.withOpacity(0.4), kColorBlack.withOpacity(0.4)],
